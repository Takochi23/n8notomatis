...
<body>
    ...
    <nav>
        ...
        <div class="auth-buttons">
            @if (Route::has('login'))
                @auth
                    <a href="{{ url('/dashboard') }}" class="welcome-btn welcome-btn-black">Ke Dashboard <i class="fa-solid fa-arrow-right"></i></a>
                @else
                    <a href="{{ route('login') }}" class="welcome-btn welcome-btn-outline">Log in</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="welcome-btn welcome-btn-black">Daftar Gratis</a>
                    @endif
                @endauth
            @endif
        </div>
    ...
    <main>
        <section class="hero">
            ...
            @if (!Auth::check())
                <a href="{{ route('register') }}" class="welcome-btn welcome-btn-black hero-cta">
